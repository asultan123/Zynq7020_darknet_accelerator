...
int testCMA(){
    ...
    float* buf = (float*)cma_alloc(length,0);
...
void reset_fabric(){
    ...
    if (!pid)
    {
        ...
        new_argv[2]="/home/xilinx/alexydarknet/modified_darknet/src/reset_fabric.py";
        new_argv[3]=0;
...
//     printf("TESTING CMA NOW>>>>>>>>>\n");

// // testCMA();
    reset_fabric();


//     printf("DONE TESTING CMA>>>>>>>>>\n");
#ifdef _DEBUG
